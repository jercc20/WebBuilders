<?php
	if( $_POST ){
		...
		$lastname2 = ( isset( $_POST['txt_lastname2'] ) ) ? $_POST['txt_lastname2'] : '';
		$userId = ( isset( $_POST['txt_user'] ) ) ? $_POST['txt_user'] : '';
		$housePhn = ( isset( $_POST['txt_phone'] ) ) ? $_POST['txt_phone'] : '';
		$CellPhn = ( isset( $_POST['txt_cellphone'] ) ) ? $_POST['txt_cellphone'] : '';
		...
		$impmt = ( isset( $_POST['txt_impairment'] ) ) ? $_POST['txt_impairment'] : '';
